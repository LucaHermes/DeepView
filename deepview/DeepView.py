...
class DeepView:
    ...
    def __init__(self, pred_fn, classes, max_samples, batch_size, data_shape, n=5,
                 ...
                 disc_dist=True, use_selector=False, class_dict=None, **kwargs):
        '''
...
#         self.selector = None
#         """
#         For right now, to use the selector feature a user must instantiate this subclass directly
#
#         TODO: either integrate selector directly or figure out how to dynamically switch  objects
#         """
#
